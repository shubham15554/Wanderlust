  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(formErrors).length > 0) {
      setErrors(formErrors);
       ...
       try{
        let message = await handleRegister(formData.name , formData.email , formData.password);
        console.log(message);
      ...
      <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="mt-5 text-center text-sm text-gray-600">
            ...
            <Link to="/signin" className="text-black font-semibold underline hover:text-gray-700 transition">
              Log in
            </Link>
          </div>
